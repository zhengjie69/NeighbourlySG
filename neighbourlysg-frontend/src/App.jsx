...
const Layout = ({ children }) => {
  return (
    <div>
      <Navbar /> {/* Always render Navbar on all pages, including login pages */}
      {children}
    </div>
  );
};
    ...
    <Router>
      <Layout>
        <Routes>
          ...
          <Route path="/surveys" element={<SurveyShowcasePage />} />{" "}
          {/* Route for SurveyShowcasePage */}
          <Route path="/CreateSurveyForm" element={<CreateSurveyForm />} />{" "}
          {/* Route for CreateSurveyPage */}
          ...
          {/* Route for ResidentEventPage */}
          <Route path="/posts" element={<CommunityPost />} />{" "}
          {/* Route for CommunityPost */}
